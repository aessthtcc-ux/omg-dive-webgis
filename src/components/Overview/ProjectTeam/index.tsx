            ...
            {teamMembers.map((member, i) => (
              ...
              >
                ...
                <div className="flex gap-2 sm:gap-3 pt-3 sm:pt-4 lg:pt-5 border-t border-gray-100 dark:border-white/5 w-full justify-center">
                  <a href={member.ig} className="p-2 sm:p-2.5 rounded-lg sm:rounded-xl bg-gray-50 dark:bg-white/5 hover:bg-pink-500 hover:text-white text-gray-400 transition-all" aria-label={`${member.name} Instagram`}>
                    <Instagram size={14} className="sm:w-4 sm:h-4" />
                  </a>
                  <a href={member.ln} className="p-2 sm:p-2.5 rounded-lg sm:rounded-xl bg-gray-50 dark:bg-white/5 hover:bg-blue-600 hover:text-white text-gray-400 transition-all" aria-label={`${member.name} LinkedIn`}>
