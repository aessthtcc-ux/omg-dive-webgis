...
const wildlifeData: WildlifeItem[] = [
  ...
  { id: 3, name: "Moray Eel", scientificName: "Gymnothorax spp.",
    ...
    likelihood: 5, likelihoodLabel: "Very Common", bestSeason: "Year-round", depth: "15 – 33 m",
  ...
  { id: 4, name: "Angelfish", scientificName: "Pomacanthidae spp.",
    ...
    likelihood: 5, likelihoodLabel: "Very Common", bestSeason: "Year-round", depth: "5 – 25 m",
  ...
  { id: 7, name: "Stingray", scientificName: "Dasyatidae spp.",
    ...
    likelihood: 2, likelihoodLabel: "Uncommon", bestSeason: "Aug – Nov", depth: "20 – 33 m",
  ...
  { id: 8, name: "Sweetlips & Grunts", scientificName: "Haemulidae spp.",
    ...
    likelihood: 3, likelihoodLabel: "Occasional", bestSeason: "Jun – Oct", depth: "10 – 30 m",
  ...
  { id: 10, name: "Pufferfish", scientificName: "Tetraodontidae spp.",
    ...
    likelihood: 2, likelihoodLabel: "Uncommon", bestSeason: "Feb – Mar, Sep", depth: "5 – 30 m",
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-start gap-1.5 pt-1">
        ...
        <p className="text-[10px] text-gray-400">Likelihood from species ecology & regional surveys.</p>
      </div>
