...
const layerGroups = [
  ...
  },
  {
    ...
    subLayers: [
      ...
      { id: "dem_pesisirpramuka",  filePath: "/data/dem/DEM_PesisirPramuka_ProjectALB_RGB_0.5m_WGS84.tif", elevPath: "/data/dem/elev/DEM_PesisirPramuka_ProjectALB_elev_0.5m_WGS84.tif", title: "DEM Pesisir Pramuka",      project: "Site 6", color: "#eab308", dash: "0", isDummy: false, isRaster: true },
    ]
  }
];
